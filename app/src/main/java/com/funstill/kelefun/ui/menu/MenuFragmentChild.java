...
public class MenuFragmentChild extends BaseBackFragment {
    ...
    private void initView(View view) {
        ...
        linearLayout.addView(new LineView(getContext())
                .initMine(R.mipmap.ic_launcher, "我的关注", true));
        linearLayout.addView(new LineView(getContext())
                .initMine(R.mipmap.ic_launcher, "我的粉丝", true));
        linearLayout.addView(new LineView(getContext())
                .initMine(R.mipmap.ic_launcher, "帮助反馈", true));
        linearLayout.addView(new LineView(getContext())
                .initMine(R.mipmap.ic_launcher, "检查更新", true));
        linearLayout.addView(new LineView(getContext())
                .initMine(R.mipmap.ic_launcher, "关于", true));
        linearLayout.addView(new LineView(getContext())
                .initMine(R.mipmap.ic_launcher, "设置", true));
